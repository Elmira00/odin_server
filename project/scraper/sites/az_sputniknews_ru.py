...
@check_source_active("https://az.sputniknews.ru/")
def get_news_links_az_sputniknews_ru(request):
    headers  = {"User-Agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36"}
    sitemap_url = "https://az.sputniknews.ru/news/"
    ...
    if response.status_code == 200:
        ...
        website_base_url = "https://az.sputniknews.ru"
        ...
        for link in links[:20]:
            title, description, content, image_url, gallery_images, news_shared_date = fetch_article_details_az_sputniknews_ru(link)
            process_article_data(
            source_link="https://az.sputniknews.ru/",
            link=link,
            title=title,
...
def fetch_article_details_az_sputniknews_ru(url):
    headers  = {"User-Agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36"}
